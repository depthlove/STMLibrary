...
Pod::Spec.new do |s|
  ...
  s.description  = <<-DESC
                            It is a component for ios make info, written by Objective-C.
                   DESC
  ...
  # Or just: s.author    = "depthlove"
  # s.authors            = { "depthlove" => "suntongmian@163.com" }
  # s.social_media_url   = "http://twitter.com/depthlove"
